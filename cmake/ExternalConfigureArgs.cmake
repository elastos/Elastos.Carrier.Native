...
if(${CMAKE_CROSSCOMPILING})
    ...
    if(IOS)
        ...
        if(${CMAKE_HOST_SYSTEM_PROCESSOR} STREQUAL "arm64")
            string(REPLACE "arm64" "arm" XDK_HOST ${XDK_HOST})
        endif()
...
#[[
    ...
    set(CONFIGURE_ARGS_INIT
        ...
        "PKG_CONFIG_PATH=${PROJECT_INT_DIST_DIR}/lib/pkgconfig")
endif()

#[[
    message("======== Compiling environment for autoconf 3rd party library =========")
    message("${CONFIGURE_ARGS_INIT}")
    message("=======================================================================")
]]
